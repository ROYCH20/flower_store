...
import {createFlower, fetchBrands, fetchFlowers, fetchTypes} from "../../http/flowerAPI";
...
const CreateFlower = observer(({show, onHide}) => {
    ...
    const addFlower = () => {
        ...
        formData.append('brandId', flower.selectedBrand.id)
        formData.append('typeId', flower.selectedType.id)
            ...
            <Modal.Body>
                <Form>
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{flower.selectedType.name || "Выберите тип"}</Dropdown.Toggle>
                        <Dropdown.Menu>
